const Logo = ({ name }) => {
    const logos = () => {
        if (name === "crypto"){
        ...
        else if (name == "keylog" || name == "snake" || name == "wblock"){
            return (
                <div className="invisible sm:visible absolute left-56 top-28 grid grid-cols-5 gap-2">
            ...
            return (
                <div className="invisible sm:visible absolute left-56 top-28 grid grid-cols-2 gap-2">
                    <img className="w-6 h-6" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/230px-Python-logo-notext.svg.png?20220821155029"></img>
                    <img className="h-6" src="https://www.pygame.org/docs/_images/pygame_logo.png"></img>
                </div>
            )
        }
    }
