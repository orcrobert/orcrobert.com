...
const ContactBox = () => {
    return (
        <>
            <section className="rounded-lg h-auto w-64 p-4 bg-gray-200 dark:bg-zinc-800 shadow-md transition ease-in-out delay-400 hover:scale-105">
                <section className="pb-2 flex gap-1">
